...
public class LineBotController: Controller
{
    ...
    public LineBotController(IOptionsMonitor<LineBotConfig> lineBotConfig, IServiceProvider serviceProvider)
    {
