...
public class LineBotAppService : WebhookApplication
{
    ...
    protected override async Task OnMessageAsync(MessageEvent ev)
    {
        ...
        switch (ev.Message)
        {
            ...
            case TextEventMessage textMessage:
            {
                ...
                var response = await Test(textMessage.Text);
                _logger.LogInformation($"Answer: {response}");
                _logger.LogInformation($"*****************************************************************************");
    ...
    private static async Task<string> Test(string question)
    {
        _logger.LogInformation($"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
